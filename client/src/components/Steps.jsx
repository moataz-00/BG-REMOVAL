            ...
            <div className='flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center'>
                ...
                <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-neutral-500 mt-1'>Quickly remove backgrounds <br /> and get high-quality images.</p>
                    </div>
                </div>
                ...
                <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-neutral-500 mt-1'>Remove backgrounds instantly <br /> for clean results.</p>
                    </div>
                </div>
                ...
                <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-neutral-500 mt-1'>Get your edited image instantly <br /> after background removal.</p>
                    </div>
                </div>
